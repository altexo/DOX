...
<!--		<div id="busquedas-relacionadas-opciones">
		...
		<span class="titulo1-datos"><? echo $nom; ?></span>
				...
				jQuery(function() {
					...
					jQuery('#prueba').jScroll({ top : 0, speed : 1000 });

				});

			</script>
		<div id="prueba" style="position:relative">
        dsakldskds dsl ds jlsdl sad lsadl ads
        </div>
