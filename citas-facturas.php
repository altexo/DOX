...
$hola = "Select * from datos where idpaciente = ".$rw['id']." and status ='cita-facturada' and autorizar = '1' order by inicio desc";
$idpaciente=$rw['id'];
		...
		?>
		 ...
		 $hola2 = "Select * from doctor where id = ".$row['iddoctor']."";
		  ...
		  echo $t." ".$row2['nombre']." ".$row2['a_paterno']." ".$row2['a_materno'];
		    ?></td>
           <td align="center"><a href="#"><img src="visual/iconos/xml.png" width="34" height="34" /></a>  &nbsp;<a href="#"><img src="visual/iconos/pdf.png" width="34" height="34" /></a></td>
         </tr>
