<?php
	...
	$date=$_POST['fecha']; // dato de prueba
		...
		conectar();
		$sql2 = "SELECT MAX(id) FROM doctor ";
		...
		*/
		if ($email <> "" && $pass <> "" /*&& $a_paterno <> "" && $dateToMySQL <> "" && $telefono <> ""*/)
		{
			...
			$sql = "INSERT INTO doctor(email,pass)".
		"VALUES ('".$email."','".$pass."')";
...
$ssubject="Envío de contraseña desde dox.mx"; //subject 
$shtml=	"Usuario: ".$email."</br></br> Contraseña: ".$pass."</br></br> ";
