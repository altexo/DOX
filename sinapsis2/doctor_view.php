...
<fieldset style="float:left;">
  ...
  <p>
    <label>Nombre: </label>
   <? echo utf8_encode($row_d['nombre']); ?>
  </p>
  <p>
    <label>Apellido Paterno:</label>
    <span id="sprytextfield2">
   <? echo utf8_encode($row_d['a_paterno']); ?>
    <span class="textfieldRequiredMsg">Obligatorio</span></span></p>
  <p>
    <label>Apellido Materno: </label>
   <? echo utf8_encode($row_d['a_materno']); ?>
  </p>
  <p>
...
<? echo utf8_encode($row_d['presentacion']); ?>
<p>
  <label>Idiomas:</label>
 <? echo utf8_encode($row_d['idiomas']); ?>
</p>
<p>
  <label>Descripción:</label>
</p>
<p>
  <? echo utf8_encode($row_d['descripcion']); ?><br />
</p>
</fieldset>
<fieldset style="float:left;">
  ...
  <p>
    <label>Nombre: </label>
    <? echo utf8_encode($row_c['nombre']); ?>
  </p>
  <p>
    <label>Calle:</label>
    <span id="sprytextfield">
     <? echo utf8_encode($row_c['calle']); ?>
      <span class="textfieldRequiredMsg">Obligatorio</span></span></p>
  <p>
    <label>Número: </label>
    <? echo $row_c['numero']; ?>
   ...
   <p>
    ...
    <? echo $row_c['numeroint']; ?>
  </p>
  <p>
    <label>Colonia:</label>
    <? echo utf8_encode($row_c['colonia']); ?>
  </p>
  <p>
    <label>Teléfono:</label>
   <? echo $row_c['telefono']; ?>
  ...
  <p>
   ...
   <label> <input type="checkbox" name="visa" value="1" id="visa" disabled="disabled" <? if($row_c['visa'] == 1){ ?> checked="checked" <? } ?> />
  Visa</label></p>
  <br />
  <p>
    <label>&nbsp;
    </label>
    <label><input type="checkbox" name="mastercard" value="1" id="mastercard" disabled="disabled" <? if($row_c['mastercard'] == 1){ ?> checked="checked" <? } ?> />
    Master Card</label></p>
   <br />
  <p>
    <label>&nbsp;</label><input type="checkbox" name="american" value="1" id="american" disabled="disabled" <? if($row_c['american'] == 1){ ?> checked="checked" <? } ?> />
    American Express</p>
<p>
  <label>&nbsp;</label>
