...
<div class="elemento">
  ...
  <div class="editar">
    ...
    <a href="#" onclick="abrir('doctor_mod.php?id=<? echo $rw['id']; ?>',0,0,0,0,0,1,1,1058,730,300,200,1);"><img src="img/b_edit.png" alt="Editar" width="16" height="16" border="0" /></a>
    </div> 
    <div class="editar">
    <a href="#" onclick="abrir('doctor_view.php?id=<? echo $rw['id']; ?>',0,0,0,0,0,1,1,1050,750,300,200,1);"><img src="img/ojo.jpg" alt="Ver" width="16" height="16" border="0" /></a>
    </div>

  <div class="editar">
  
    <a href="#" onclick="abrir('doctor_del.php?id=<? echo $rw['id']; ?>',0,0,0,0,0,1,1,300,170,300,200,1);"><img src="img/b_drop.png" width="16" height="16" alt="Eliminar" border="0" /></a>
