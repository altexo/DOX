...
<body>
<p><span class="test3" style="font-weight:bold; margin-left:10px; margin-bottom:10px">ELIMINAR GALERÍA</span></p>
<form action="insert_doc.php" method="post" enctype="multipart/form-data" name="form1" target="imagen" id="form1" >
  <fieldset style="float:left;">
    ...
    <p><img width="96" height="107" /> <img width="96" height="107" /> <img width="96" height="107" /> <img width="96" height="107" /><br />
      <label>Eliminar x</label><label>Eliminar x</label><label>Eliminar x</label><label>Eliminar x</label>
    </p>
    <p>&nbsp;</p>
  </fieldset>
</form>
