...
<div id="contenedor"> 
  ...
  <? include('menu.php')?>
  <form action="seguro.php" method="post" enctype="multipart/form-data" name="form1" target="imagen" id="form1" >
    <div id="interfaz">
      <p><span class="txt_titulo1">Seguros</span><span class="txt_titulo1"><br />
      </span></p>
      <p>&nbsp;</p>
      <p>
        <input style="background:#F60; line-height:50px; border-bottom-style:solid; border-bottom-width:1px; border-color:#CCC; width:130px; height:40px; color:#FFF; padding: 10px;  -moz-border-radius: 10px; -webkit-border-radius:10px; float:left; margin-right: 2px;" type="submit" name="button" id="button" value="+ Agregar Seguro" onclick="abrir('seguro_ins.php',0,0,0,0,0,1,1,480,280,180,200,1);" />
...
<div id="etiquetas_deudores">
  <div id="cliente" style="width:400px">Nombre </div>
  <div id="monto">Logo</div>
</div>
...
?>
<div class="elemento">
  <div class="cliente1" style="width:414px">
    
    <?  echo utf8_encode($rw['nombre']); ?>
  </div>
  <div class="logo_seguro" >
  <img src="logo_seguro/<? echo $rw['logo']; ?>" alt="Logo"  height="40" border="0"  align="absmiddle" />
  </div>
  <div class="editar">
    
    <a href="#" onclick="abrir('seguro_mod.php?id=<? echo $rw['id']; ?>',0,0,0,0,0,1,1,1050,480,280,200,1);"><img src="img/b_edit.png" alt="Editar" width="16" height="16" border="0" /></a>
  </div>
  <div class="editar">
    
    <a href="#" onclick="abrir('seguro_del.php?id=<? echo $rw['id']; ?>',0,0,0,0,0,1,1,300,170,300,200,1);"><img src="img/b_drop.png" width="16" height="16" alt="Eliminar" border="0" /></a>
