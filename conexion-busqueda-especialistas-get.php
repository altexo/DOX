...
do {
	...
	$horarios = mysql_query("select * from datos where iddoctor 
			...
			and status='cita-web' and titulo='' order by hinicio asc");	
$horas = array();
...
echo json_encode(array("especialidad" => $nom, "resultados" => $results, "horas" => $horas));
	}
