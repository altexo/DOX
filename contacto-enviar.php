...
$ssubject="Mensaje generado desde contacto DOX.mx"; //título
...
<table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" style=\"font-family:arial\" >
 ...
 <p>-----------------------------------------</p>
 <b>Comentarios:</b> ".$_POST["domicilio"]."
 <p>-----------------------------------------</p>
...
// ENVÍA SEGUNDO CORREO

$sfrom="DOX <no_contestar@dox.mx>"; //cuenta que envia 
$sdestinatario=$_POST["correo"]; //cuenta destino 
$ssubject="¡Gracias por interesarse en DOX.mx!"; //título
...
<?php include("cabeza.php"); ?>
		...
		<div id="faq-contenido-contacto">
			...
			<div id="formulario-especialistas"><span id="sprytextfield1">
			  <input name="nombre" type="text" disabled="disabled" placeholder="Nombre"/>
			  ...
			  <textarea name="domicilio" disabled="disabled" placeholder="Comentarios"></textarea>
			  <span class="textareaRequiredMsg">Se requiere ingreses un mensaje.<br />
			  </span></span>
			  <p>¡Mensaje enviado exitosamente! Muchas gracias por tu interés en DOX.mx</p>
            </div></form>
