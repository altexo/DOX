<?php
	...
	/*$date=$_POST['fecha']; // dato de prueba
		...
		$sql_e="Update doctor Set titulo = '".$titulo."',nombre = '".$nombre."',a_paterno = '".$a_paterno."',a_materno = '".$a_materno."',fecha_nacimiento = '".$nacimiento."',telefono = '".$telefono."',celular = '".$celular."',nextel = '".$nextel."',educacion = '".$educacion."' ,idiomas = '".$idiomas."' ,certificaciones = '".$certificaciones."',seguros = '".$seg."',tarjetas = '".$tarjetas."', pass = '".$pass."', cedula = '".$cedula."',cedula_esp = '".$cedula_esp."',publicar = '".$publicar."' where id = '".$id."'";
		
		$sql_c= "Update clinica Set nombre = '".$nombre_c."',calle = '".$calle."', numero = '".$numero."',numeroint = '".$numeroint."', colonia = '".$colonia."',telefono = '".$telefono_c."',id_ciudad = '".$ciudad."', latitud = '".$latitud."',longitud = '".$longitud."', especialidad = '".$esp."' where id_doctor = '".$id."'";
		...
		if ($result2 = mysql_query($sql_c) && $result3 = mysql_query($sql_e))
		{
