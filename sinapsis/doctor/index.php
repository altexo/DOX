...
$error="";
 if( isset($_POST['user'])  && isset($_POST['pass']) )
 {
	...
	conectar();
	$sql = "SELECT * FROM doctor WHERE email = '$user' AND pass = '$pass'";
	...
	if(mysql_num_rows($result)==1)
	{
		...
		desconectar();
		header("Location: doctor_ins.php");
	}
	else
	{
...
<style type="text/css">
* { outline:none; }
body { font: 72.5% "Lucida Grande", Arial, sans-serif; margin: 30px 0; background-color: #ffffff; color: #666; }
...
<div id="admin_main">
<h3>Prellenado de campos de su Perfil Médico</h3>
