...
<body>
<p><span class="test3" style="font-weight:bold; margin-left:10px; margin-bottom:10px; color:#004A8F;">Bienvenido, estás solo a un paso de entrar a la Red de Médicos de Dox.</span></p>
<p>**Nota importante, una vez llenados tus datos pasarán a ser revisados y verificados. Ya que se publiquen en el sitio algunos campos no podrán ser modificados sin validación previa**</p>
...
<meta name="viewport" content="initial-scale=1.0, user-scalable=no" />
  ...
  <p>
    ...
    <select name="ciudad" id="ciudad">
      ...
      <option value="<? echo utf8_encode($row['nombre']); ?>"><? echo utf8_encode($row['nombre']); ?></option>
      <? } 
	 desconectar();
	 ?>
    </select>
  ...
  <p>&nbsp;</p>
  <p>
    <input type="submit" name="guardar" id="guardar" value="Enviar Solicitud" />
 </p>
 <p>
