...
?>
<body>
<p><span class="test3" style="font-weight:bold; margin-left:10px; margin-bottom:10px">ELIMINAR PACIENTE</span></p>
<form action="paciente_del.php?id=<? echo $id; ?>" method="post" enctype="multipart/form-data" name="form1" target="" id="form1" >
