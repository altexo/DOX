function raiz(iddoctor,id,start,end,title,status,sql,clinica)
{
...
consulta_ajax(objeto_final.iddoctor,objeto_final.id,objeto_final.inicio,objeto_final.fin,objeto_final.hinicio,objeto_final.hfinal,objeto_final.titulo,objeto_final.status,objeto_final.sql,objeto_final.clinica);
...
function consulta_ajax(i,a,s,d,f,g,h,j,k,c)
{
	

var url = 'consulta.php?iddoctor='+i+'&id='+a+'&inicio='+s+'&final='+d+'&hinicio='+f+'&hfinal='+g+'&titulo='+h+'&status='+j+'&sql='+k+'&clinica='+c;
	ajax  =  objetoAjax();
