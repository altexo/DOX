...
<style>
	...
	#dia1,#dia2,#dia3,#dia4,#dia5,#dia6,#dia7{font-weight:bold;color:#626262;font-size:12px;float:left;width:100px;
		text-align:center;font-family:Lucida Sans Unicode,arial,ubuntu;}
	#hora1,#hora2,#hora3,#hora4,#hora5,#hora6,#hora7{font-size:12px;float:left;width:100px;text-align:center;
	font-family:Lucida Sans Unicode,arial,ubuntu;height:20px;}
	...
	#cabecera{font-weight:bold;font-family:Lucida Sans Unicode,ubuntu;text-align:left;margin-bottom:60px;
