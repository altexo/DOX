...
<h1><? if(isset($mensaje)){echo $mensaje;} ?> </h1>
   ...
   <a href="http://www.dox.mx/ficha-doctor.php?id=<? echo $row['id']; ?>&clinica=<? echo $row2[19]; ?>" target="_blank"  class="botonclinica">Ir a mi ficha personal</a><a class="botonclinica" href="http://www.dox.mx/ficha-doctor.php?id=<? echo $row['id']; ?>&clinica=<? echo $row2[19]; ?>" target="_blank">Clínica <? echo $row2[21]; ?></a><? } ?>
		...
		<form>
			...
			<ul>
                ...
                <label for="bodyf">Información: </label><textarea name="bodyf" cols="31" rows="9"></textarea>
                 ...
                 <li>
                <label for="miemail">Email: </label><input name="miemail" cols="31" rows="9"></textarea>
