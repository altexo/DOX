...
function consulta_ajax_movimiento(arreglo){
	...
	var fechas_send = arreglo;
	fechas_send = fechas_get();

	ajax = new objetoAjax();
	var url = 'consulta_fecha.php?1='+fechas_send[1]+'&2='+fechas_send[2]+'&3='+fechas_send[3]+'&4='+fechas_send[4]+'&5='+fechas_send[5]+'&6='+fechas_send[6]+'&7='+fechas_send[7];	
